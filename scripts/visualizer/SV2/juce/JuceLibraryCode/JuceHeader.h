...
#ifndef __APPHEADERFILE_JKPJAX__
#define __APPHEADERFILE_JKPJAX__
...
#include "AppConfig.h"
 ...
 #include "/Users/slayton/src/juce/juce_amalgamated.h"
#endif

namespace ProjectInfo
{
    const char* const  projectName    = "jSpike";
    const char* const  versionString  = "1.0.0";
    const int          versionNumber  = 0x10000;
}

#endif   // __APPHEADERFILE_JKPJAX__
