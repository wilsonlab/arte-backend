...
const std::string default_setup_config_filename "arte-ephys/conf/arte_setup_default.conf";
const std::string default_session_config_filename "arte-ephys/conf/arte_session_default.conf";
